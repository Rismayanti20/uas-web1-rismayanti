                            ...
                            <div class="card">
                                ...
                                <form role="form" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-footer">
                                        <input type="submit" class="btn btn-primary" name="post_data" value="Submit">
...
if (isset($_POST['post_data'])) {
    ...
    if (empty($password)) {
        $postData = mysqli_query($connect, "UPDATE users SET nama='$namaLengkap', username='$username' WHERE id='$id'");
        if ($postData) {
            ?>
        ...
        if ($password == $repassword) {
            $postData = mysqli_query($connect, "UPDATE users SET nama='$namaLengkap', username='$username', password='$password' WHERE id='$id'");
            if ($postData) {
                ?>
                <script type="text/javascript">
                    alert("Edit data berhasil");
