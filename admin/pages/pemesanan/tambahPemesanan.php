                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="id_paket" class="form-control">
                                                    ...
                                                    while ($dataPaket = mysqli_fetch_assoc($paket)) {
                                                        ?>
                                                        <option value="<?php echo $dataPaket['id'] ?>"><?php echo $dataPaket['nama'] ?></option>
                                                        <?php
                                                    }
                                                    ?>
                                                </select>
...
if (isset($_POST['post_data'])) {
    ...
    if ($uploadGambar) {
        $postData = mysqli_query($connect, "INSERT INTO pemesanan (no_pesan, id_paket, nama_lengkap, alamat, no_telp, tgl_foto, bukti_bayar) VALUES ('$noPesan', '$paket', '$namaLengkap', '$alamat', '$noTelp', '$tglFoto', '$buktiBayar')");
    }
