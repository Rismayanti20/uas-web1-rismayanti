...
$id_data = $_GET['id'];
$getData = mysqli_query($connect, "SELECT * FROM paket WHERE id='$id_data'");
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Edit Paket Harga</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
...
if (isset($_POST['post_data'])) {
    ...
    $postData = mysqli_query($connect, "UPDATE paket SET nama='$namaPaket', harga='$replaceRp', rincian='$rincian' WHERE id='$id_data'");
