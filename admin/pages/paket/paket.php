        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Paket Harga</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 1;
                                            $sql = mysqli_query($connect, "SELECT * FROM paket");
                                            while ($data = mysqli_fetch_assoc(($sql))) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="editPaket.php?id=<?php echo $data['id'] ?>"
                                                            class="btn btn-info">
                                                            <i class="fas fa-pencil-alt"></i>
                                                        </a>
                                                        <a href="hapusPaket.php?id=<?php echo $data['id'] ?>"
