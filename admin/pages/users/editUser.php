...
$id_data = $_GET['id'];
$getData = mysqli_query($connect, "SELECT * FROM users WHERE id='$id_data'");
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="nama" required
                                                    placeholder="Nama Lengkap" value="<?php echo $detail['nama'] ?>">
                                            </div>
                                            <div class="form-group">
                                                <label>Username</label>
                                                <input type="text" class="form-control" name="username" required
                                                    placeholder="Username" value="<?php echo $detail['username'] ?>">
                                            </div>
                                        </div>
                                        <!-- /.card-body -->
...
if (isset($_POST['post_data'])) {
    ...
    $postData = mysqli_query($connect, "UPDATE users SET nama='$namaLengkap', username='$username' WHERE id='$id_data'");
