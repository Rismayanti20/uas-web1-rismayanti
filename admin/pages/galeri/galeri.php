                                        ...
                                        <tbody>
                                            ...
                                            while ($data = mysqli_fetch_assoc($sql)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $data['tgl_gambar'] ?>
                                                    </td>
                                                    <td class="text-center">
                                                        <img src="dataGaleri/<?php echo $data['url_gambar'] ?>"
                                                            class="img-thumbnail" width="100" alt="">
                                                    </td>
                                                    <td>
                                                        <a href="editGaleri.php?id=<?php echo $data['id'] ?>"
                                                            class="btn btn-info">
                                                            <i class="fas fa-pencil-alt"></i>
                                                        </a>
                                                        <a href="hapusGaleri.php?id=<?php echo $data['id'] ?>"
