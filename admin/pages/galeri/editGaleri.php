...
$id_data = $_GET['id'];
$getData = mysqli_query($connect, "SELECT * FROM galeri WHERE id='$id_data'");
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="nama_gambar"
                                                    value="<?php echo $detail['nama_gambar']; ?>" required
                                                    placeholder="Nama Gambar">
                                            </div>
                                            <div class="form-group">
                                                <label>Tanggal Gambar</label>
                                                <input type="date" class="form-control"
                                                    value="<?php echo $detail['tgl_gambar']; ?>" name="tgl_gambar"
                                                    required placeholder="Tanggal Gambar">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputFile">File Gambar</label>
                                                <div class="input-group">
                                                    <div class="my-5">
                                                        <img src="dataGaleri/<?php echo $detail['url_gambar']; ?>"
                                                            width="150">
                                                    </div>
...
if (isset($_POST['post_data'])) {
    ...
    if (!empty($tmp)) {
        ...
        $editData = mysqli_query($connect, "UPDATE galeri SET nama_gambar = '$namaGambar', tgl_gambar = '$tglGambar', url_gambar = '$urlGambar' WHERE id = '$id_data'");
        if ($editData) {
            ?>
            <script type="text/javascript">
        ...
        $editData = mysqli_query($connect, "UPDATE galeri SET nama_gambar = '$namaGambar', tgl_gambar = '$tglGambar' WHERE id = '$id_data'");
        if ($editData) {
            ?>
            <script type="text/javascript">
                alert("Edit data berhasil");
